...
namespace CACTI.Units.Masses
{
    public class Mass : UnitValue<MassDimension, Mass>
    {
        ...
        public static bool TryParse(string valueString, out Mass parsed)
            => TryParse(valueString, null, out parsed);

        public static bool TryParse(string valueString, IFormatProvider formatProvider, out Mass parsed)
        {

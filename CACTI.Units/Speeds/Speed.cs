...
namespace CACTI.Units.Speeds
{
    public class Speed : UnitValue<SpeedDimension, Speed>
    {
        ...
        public static bool TryParse(string valueString, out Speed speed)
            => TryParse(valueString, null, out speed);

        public static bool TryParse(string valueString, IFormatProvider formatProvider, out Speed speed)
        {

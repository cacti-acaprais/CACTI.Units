...
namespace CACTI.Units.Durations
{
    public class Duration : UnitValue<DurationDimension, Duration>
    {
        ...
        public static bool TryParse(string valueString, [NotNullWhen(true)] out Duration? duration)
            => TryParse(valueString, null, out duration);

        public static bool TryParse(string valueString, IFormatProvider? formatProvider, [NotNullWhen(true)] out Duration? duration)
        {

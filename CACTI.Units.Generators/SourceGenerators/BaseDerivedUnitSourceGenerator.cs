...
{
    internal class BaseDerivedUnitSourceGenerator
    {
        private readonly DerivedDimensionDeclaration _dimensionDeclaration;

        public BaseDerivedUnitSourceGenerator(DerivedDimensionDeclaration dimensionDeclaration)
        {
...
{{
    public partial class {_dimensionDeclaration.Name} : {_dimensionDeclaration.DerivedDimensionName}, IUnitValue<{_dimensionDeclaration.Name}Dimension, {_dimensionDeclaration.Name}>
    {{
